import { c as create_ssr_component, f as createEventDispatcher, d as add_attribute } from "./index-7280390d.js";
...
const MarkdownEditor = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `${$$result.head += `<script src="${"https://cdn.jsdelivr.net/simplemde/latest/simplemde.min.js"}" data-svelte="svelte-9h8q5l"><\/script>`, ""}

<div class="${"editor svelte-1kgnghm"}"><textarea class="${"editor svelte-1kgnghm"}"${add_attribute("this", editorNode, 0)}></textarea>
</div>`;
});
