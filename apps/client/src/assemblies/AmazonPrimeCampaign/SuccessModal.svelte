...
<Modal {isDisplayed} on:dismiss={() => dispatch('dismiss')} zIndex={99}>
  <div class="amazon-campaign-success-modal" slot="content">
    <div class="flex">
      <CheckmarkIcon />
    </div>
  ...
  <div class="amazon-campaign-success-modal" slot="actions">
...
<style>
  ...
  :global(.amazon-campaign-success-modal .flex svg) {
    width: 80px;
    height: 80px;
    margin: 0 auto 24px;
  ...
  :global(.campaign-page .amazon-campaign-success-modal .custom-checkbox svg) {
    margin-bottom: -4px;
    margin-top: 0;
  }
  ...
  :global(.amazon-campaign-success-modal label) {
    margin: 0;
    color: var(--interactive-color);
  }

  :global(.amazon-campaign-success-modal .card) {
    padding-top: 16px;
    padding-bottom: 8px;
  ...
  @media screen and (max-width: 500px) {
    :global(.actions .amazon-campaign-success-modal) {
