import { c as create_ssr_component, v as validate_component, e as escape } from "./index-4390b0b8.js";
import dayjs from "dayjs";
import { C as Card } from "./Card-0ad50115.js";
var Hourglass_svelte_svelte_type_style_lang = "";
const css$1 = {
  code: ":root{--sandColor:var(--interactive-color);--glassColor:var(--visualization-color);--hourglassSize:4.25rem}#hourglass.svelte-ls2ua7.svelte-ls2ua7{display:inline-block;transition-property:transform;transition-duration:700ms;transition-timing-function:ease}.glass.svelte-ls2ua7.svelte-ls2ua7{z-index:1;position:relative;background-color:var(--glassColor);clip-path:polygon(0 0, 100% 0, 50% 100%);height:var(--hourglassSize);width:calc(var(--hourglassSize) * 1.5);bottom:-0.2em;overflow:hidden;border-top-left-radius:20% 100%;border-top-right-radius:20% 100%;margin:0 auto}.top.svelte-ls2ua7.svelte-ls2ua7{z-index:2}.glass.bottom.svelte-ls2ua7.svelte-ls2ua7{z-index:0;top:-0.2em;clip-path:polygon(50% 0, 100% 100%, 0 100%);border-top-left-radius:0;border-top-right-radius:0;border-bottom-left-radius:20% 100%;border-bottom-right-radius:20% 100%}.sand.top.svelte-ls2ua7.svelte-ls2ua7:after{position:absolute;content:'';width:100%;top:-20px;height:20px;border-bottom-left-radius:50% 70%;border-bottom-right-radius:50% 70%;background-color:transparent;box-shadow:0 10px 0 var(--sandColor);animation:svelte-ls2ua7-kfSandTop 2000ms ease-in-out infinite}.sand.svelte-ls2ua7.svelte-ls2ua7{position:absolute;background-color:var(--sandColor);min-width:100%;height:100%;bottom:0}#hourglass.ready.svelte-ls2ua7 .sand.svelte-ls2ua7{transition-property:height;transition-timing-function:ease-out;transition-duration:200ms}.glass.bottom.svelte-ls2ua7 .sand.svelte-ls2ua7{height:0;border-top-left-radius:50% 100%;border-top-right-radius:50% 100%;border-bottom-left-radius:0;border-bottom-right-radius:0;transition-timing-function:ease-in;animation:svelte-ls2ua7-kfSandBottom 3000ms ease infinite}.glass.bottom.svelte-ls2ua7.svelte-ls2ua7:before{position:absolute;content:'';background-color:var(--sandColor);height:98%;width:3px;bottom:0;left:50%;transform:translate(-50%)}@keyframes svelte-ls2ua7-kfSandStream{0%{height:0;transform:rotate(10deg)}10%{height:100%;top:0;transform:rotate(-15deg)}95%{height:100%;top:0}100%{height:0;top:100%}}@keyframes svelte-ls2ua7-kfSand{0%{border-top-left-radius:20% 20%;border-top-right-radius:20% 20%}50%{border-top-left-radius:50% 40%;border-top-right-radius:50% 40%}}@keyframes svelte-ls2ua7-kfSandTop{0%{border-bottom-left-radius:50% 50%;border-bottom-right-radius:50% 50%}50%{border-bottom-left-radius:50% 80%;border-bottom-right-radius:50% 80%}100%{border-bottom-left-radius:50% 50%;border-bottom-right-radius:50% 50%}}@keyframes svelte-ls2ua7-kfSandBottom{0%{border-top-left-radius:50% 100%;border-top-right-radius:50% 100%}50%{border-top-left-radius:100% 150%;border-top-right-radius:100% 150%}100%{border-top-left-radius:50% 100%;border-top-right-radius:50% 100%}}@keyframes svelte-ls2ua7-kfFlip{0%{transform:rotate(0deg)}100%{transform:rotate(180deg)}}",
  map: null
};
const Hourglass = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div id="${"hourglass"}" class="${"ready svelte-ls2ua7"}"><div class="${"glass svelte-ls2ua7"}"><div class="${"sand top svelte-ls2ua7"}"></div></div>
  <div class="${"glass bottom svelte-ls2ua7"}"><div class="${"sand bottom svelte-ls2ua7"}"></div></div>
</div>`;
});
