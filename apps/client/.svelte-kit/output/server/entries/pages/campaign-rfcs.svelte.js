...
const Campaign_rfcs = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `${$$result.head += `${$$result.title = `<title>Late-Stage: Campaign RFC</title>`, ""}`, ""}

${validate_component(Controls, "Controls").$$render($$result, {}, {}, {})}

<main class="${"audit svelte-1wz7a0g"}"><h1>RFC - Campaigns</h1>
  ...
  <h4 class="${"svelte-1wz7a0g"}">What do you mean by &quot;campaign&quot;?</h4>
  ...
  <div class="${"quick-links svelte-1wz7a0g"}"${add_attribute("this", quickLinksNode, 0)}>${validate_component(Card, "Card").$$render($$result, {}, {}, {
    default: () => {
      ...
      <a href="${"#campaign-idea-template"}" class="${"svelte-1wz7a0g"}">Campaign Idea Template</a>`;
    }
  })}</div>

  ${validate_component(Card, "Card").$$render($$result, {}, {}, {
    default: () => {
      return `<h2 class="${"petition-heading"}">${validate_component(Campaign, "CampaignIcon").$$render($$result, {}, {}, {})} I have a Campaign Idea!</h2>

    <p>We&#39;re excited to hear it! There are few things to consider before we take it on:</p>

    <h4 class="${"svelte-1wz7a0g"}">Focused, Time-Bound Impact</h4>
    ...
    <h4 class="${"svelte-1wz7a0g"}">How does it fit in the ecosystem?</h4>
  ...
  <section${add_attribute("this", campaignIdeaTemplateNode, 0)}>${validate_component(Card, "Card").$$render($$result, {}, {}, {
    default: () => {
      return `<h2>${validate_component(Pencil, "PencilIcon").$$render($$result, {}, {}, {})} Campaign Idea Template</h2>
    ...
    <button class="${"primary svelte-1wz7a0g"}">Copy To Clipboard and Open Reddit</button></section>
</main>`;
});
