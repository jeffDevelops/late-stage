const c = [
	...
	() => import("../../src/routes/password-reset-callback.svelte"),
...
export const routes = [
	...
	// src/routes/password-reset-callback.svelte
	[/^\/password-reset-callback\/?$/, [c[0], c[3]], [c[1]]],

	// src/routes/confirm-user-callback.svelte
	[/^\/confirm-user-callback\/?$/, [c[0], c[4]], [c[1]]],

	// src/routes/checklist-rfcs.svelte
	[/^\/checklist-rfcs\/?$/, [c[0], c[5]], [c[1]]],

	// src/routes/reset-password.svelte
	[/^\/reset-password\/?$/, [c[0], c[6]], [c[1]]],

	// src/routes/campaign-rfcs.svelte
	[/^\/campaign-rfcs\/?$/, [c[0], c[7]], [c[1]]],

	// src/routes/verify-email.svelte
	[/^\/verify-email\/?$/, [c[0], c[8]], [c[1]]],

	// src/routes/campaigns/[id].svelte
	[/^\/campaigns\/([^/]+?)\/?$/, [c[0], c[9]], [c[1]], (m) => ({ id: d(m[1])})],

	// src/routes/checklist.svelte
	[/^\/checklist\/?$/, [c[0], c[10]], [c[1]]],

	// src/routes/resources.svelte
	[/^\/resources\/?$/, [c[0], c[11]], [c[1]]],

	// src/routes/register.svelte
	[/^\/register\/?$/, [c[0], c[12]], [c[1]]],
